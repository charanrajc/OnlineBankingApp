    ...
    <td colspan="2"><table width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
      <tr>
        <th colspan="2" scope="col"><div class="box1">
          <marquee>
            <h2><font color="#0461f7">Welcome To Online Bank.</font></h2>
            </marquee>
        </div></th>
        </tr>
      <tr>
        <th width="50%" scope="col"><form id="form1" name="form1" method="post" action="LoginServlet">
          <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" style="border:#000000 solid 2px; padding:5px;">
            ...
            <tr>
              <td colspan="3">Want to Create a New Account? <a href="RegisterCustomer">Click Here</a> </td>
              </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
