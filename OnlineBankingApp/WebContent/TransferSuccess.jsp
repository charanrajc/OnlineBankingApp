...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<div class="box2">
	Your Amount <font  color="#FF0000"><%= (Integer)session.getAttribute("transferAmount")%></font> is Successfully Transfer to Acount <font color="#FF0000"><%= (Integer)session.getAttribute("destAccountNum")%> Rs.</font><br/>
