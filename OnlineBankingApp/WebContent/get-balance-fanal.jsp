...
int account_Number = (Integer)session.getAttribute("account_Num");

int current_Balance = 0;

if(session.getAttribute("current_Balance") != null)
{
	current_Balance = (Integer)session.getAttribute("current_Balance");
}
	...
	<form id="form1" name="form1" method="post" action="">
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td><div align="right"><strong>:</strong></div></td>
          <td>&nbsp;<font color="#FF0000"><%=current_Balance%> Rs. </font></td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;If you want to Deposite then <a href="deposite">Click Here</a><br/> Or For Withdrow the Ammount fro Your Account <a href="withdraw">Click here</a></td>
          </tr>
        <tr>
          <td width="43%">&nbsp;</td>
          <td width="2%">&nbsp;</td>
