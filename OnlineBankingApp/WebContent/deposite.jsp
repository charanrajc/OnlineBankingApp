...
if(session.getAttribute("accountNumberList") != null)
{
	accountNumberList= (ArrayList)session.getAttribute("accountNumberList");
}
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<form id="form1" name="form1" method="post" action="deposite">
	  <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td><label>
			...
			%>
			<option value="<%=(Integer)accountNumberList.get(i)%>">Acc No : <%=(Integer)accountNumberList.get(i)%></option>
			<% } %>
			</select>
          </label></td>
        </tr>
