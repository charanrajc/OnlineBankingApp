...
if(session.getAttribute("accountNumbers") != null)
{
	accountNumberList= (ArrayList)session.getAttribute("accountNumbers");
}
%>
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<form id="form1" name="form1" method="post" action="withdraw">
