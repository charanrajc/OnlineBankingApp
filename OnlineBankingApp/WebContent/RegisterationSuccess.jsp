...
System.out.print(" session.getAttribute::::"+session.getAttribute("count"));
	if(session.getAttribute("count") != null)
	{
		register_count = (Integer) session.getAttribute("count");
		System.out.print(" register_count ::::"+register_count);
	}
%>
...
<p>&nbsp;</p>	</td>
	...
	if(register_count > 0){
	%>
	Account is Created Successfully.<br/><a href="login.jsp">Click Here</a> to Login and Acticvate Your Account.
	<%
	}else {
	%>
	<font color="#FF0000">Sorry!. Account is not created.<br/>Click Here to <a href="RegisterCustomer">Register Again</a></font>
	<%
	}
	 %>
	</div>
