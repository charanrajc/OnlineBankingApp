...
if(session.getAttribute("accountNumberLis") != null)
{
	accountNumberList= (ArrayList)session.getAttribute("accountNumberLis");
}
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<br/>
	<form id="form1" name="form1" method="post" action="getBalance">
