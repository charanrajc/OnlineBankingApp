...
if(session.getAttribute("Acc_balance") != null)
{
	balance =(Integer)session.getAttribute("Acc_balance");
}
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<div class="box2">
	Your Amount is Successfully Deposited into Acount. Your current Balance is: <font color="#FF0000"><%=balance%> Rs.</font><br/>
